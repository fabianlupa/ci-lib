...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZCILIB_HOST_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZCILIB_HOST_V_EXTRACT
TOTAL = ZCILIB_HOST_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZCILIB_HOST_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZCILIB_HOST_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCILIB_HOST_V_EXTRACT
TOTAL = ZCILIB_HOST_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZCILIB_HOST_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZCILIB_HOST_V'
...
TOTAL = ZCILIB_HOST_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZCILIB_HOST_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZCILIB_HOST_V-UPD_FLAG NE SPACE.
