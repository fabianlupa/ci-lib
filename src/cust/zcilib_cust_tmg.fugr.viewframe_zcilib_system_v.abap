*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZCILIB_SYSTEM_V
*   generation date: 28.12.2018 at 15:52:47
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZCILIB_SYSTEM_V     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZCILIB_SYSTEM_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZCILIB_SYSTEM_V_EXTRACT
TOTAL = ZCILIB_SYSTEM_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZCILIB_SYSTEM_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZCILIB_SYSTEM_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCILIB_SYSTEM_V_EXTRACT
TOTAL = ZCILIB_SYSTEM_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZCILIB_SYSTEM_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZCILIB_SYSTEM_V'
...
TOTAL = ZCILIB_SYSTEM_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZCILIB_SYSTEM_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZCILIB_SYSTEM_V-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZCILIB_SYSTEM_V'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZCILIB_SYSTEM_V-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCILIB_SYSTEM_V_EXTRACT
TOTAL = ZCILIB_SYSTEM_V_TOTAL
