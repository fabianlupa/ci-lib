...
CLASS lcl_main IMPLEMENTATION.
  METHOD run.
    ...
    LOOP AT li_host->get_comments_for_pull_request( iv_repository = 'department-a/test-project' iv_pull_request = 1
      iv_by_author = 'cts-bot' )
      ASSIGNING FIELD-SYMBOL(<ls_comment>).
      WRITE: / li_host->get_pr_comment_content( iv_repository = 'department-a/test-project' iv_pull_request = 1 iv_comment = <ls_comment>-id ).
